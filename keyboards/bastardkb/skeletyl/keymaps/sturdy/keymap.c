...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[4] = LAYOUT_split_3x5_3(
        RCS(KC_V), KC_MSTP, KC_MPLY, RCS(KC_C), BL_UP,                                  KC_F12, KC_F7, KC_F8, KC_F9, KC_BRIU,
        OSM(MOD_LALT), OSM(MOD_LGUI), OSM(MOD_LSFT), OSM(MOD_LCTL), BL_DOWN,            KC_F11, KC_F4, KC_F5, KC_F6, KC_BRID,
